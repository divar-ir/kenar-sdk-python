...
class TestAddonsBusinessAddon(unittest.TestCase):
    """AddonsBusinessAddon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddonsBusinessAddon:
        """Test AddonsBusinessAddon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddonsBusinessAddon`
        """
        model = AddonsBusinessAddon()
        if include_optional:
            return AddonsBusinessAddon(
                business_ref = '',
    ...
    def testAddonsBusinessAddon(self):
        """Test AddonsBusinessAddon"""
