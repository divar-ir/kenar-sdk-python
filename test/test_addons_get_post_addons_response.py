...
class TestAddonsGetPostAddonsResponse(unittest.TestCase):
    """AddonsGetPostAddonsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddonsGetPostAddonsResponse:
        """Test AddonsGetPostAddonsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddonsGetPostAddonsResponse`
        """
        model = AddonsGetPostAddonsResponse()
        if include_optional:
            return AddonsGetPostAddonsResponse(
                addons = [
...
برقرار باشند(
    ...
    def testAddonsGetPostAddonsResponse(self):
        """Test AddonsGetPostAddonsResponse"""
