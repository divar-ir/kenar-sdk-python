...
class AssetsGetOAuthScopesResponse(BaseModel):
    """
    AssetsGetOAuthScopesResponse
    """ # noqa: E501
    scopes: Optional[List[AssetsGetOAuthScopesResponseAppOauthScope]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scopes": [AssetsGetOAuthScopesResponseAppOauthScope.from_dict(_item) for _item in obj["scopes"]] if obj.get("scopes") is not None else None
        })
        return _obj
