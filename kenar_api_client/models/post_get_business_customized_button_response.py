...
class PostGetBusinessCustomizedButtonResponse(BaseModel):
    """
    ...
    type: Optional[PostCustomizedButtonType] = None
    __properties: ClassVar[List[str]] = ["app_name", "app_slug", "is_active", "type"]
