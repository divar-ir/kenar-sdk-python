...
class AssetsGetColorsResponse(BaseModel):
    """
    AssetsGetColorsResponse
    """ # noqa: E501
    colors: Optional[List[AssetsEnumOption]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "colors": [AssetsEnumOption.from_dict(_item) for _item in obj["colors"]] if obj.get("colors") is not None else None
        })
        return _obj
