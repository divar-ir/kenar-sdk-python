...
class FinderSearchPostsV2Request(BaseModel):
    """
    ...
    query: Optional[FinderSearchQuery] = None
    __properties: ClassVar[List[str]] = ["category", "city", "districts", "query"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "query": FinderSearchQuery.from_dict(obj["query"]) if obj.get("query") is not None else None
        })
        return _obj
