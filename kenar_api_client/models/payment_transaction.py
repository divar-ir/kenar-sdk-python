...
class PaymentTransaction(BaseModel):
    ...
    PaymentTransaction
    """ # noqa: E501
    app_slug: Optional[StrictStr] = Field(default=None, description="شناسه اپلیکیشنی که تراکنش را ایجاد کرده است")
    cost_rials: Optional[StrictStr] = Field(default=None, description="هزینه تراکنش به ریال برای اپلیکیشن شما")
    created_at: Optional[datetime] = Field(default=None, description="زمان ایجاد تراکنش")
    ...
    __properties: ClassVar[List[str]] = ["app_slug", "cost_rials", "created_at", "extra_details", "id", "state", "type"]
