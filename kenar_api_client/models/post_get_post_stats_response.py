...
class PostGetPostStatsResponse(BaseModel):
    ...
    """ # noqa: E501
    chats: Optional[GetPostStatsResponsePostStats] = None
    impressions: Optional[GetPostStatsResponsePostStats] = None
    views: Optional[GetPostStatsResponsePostStats] = None
    __properties: ClassVar[List[str]] = ["chats", "impressions", "views"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of impressions
        if self.impressions:
            _dict['impressions'] = self.impressions.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chats": GetPostStatsResponsePostStats.from_dict(obj["chats"]) if obj.get("chats") is not None else None,
            "impressions": GetPostStatsResponsePostStats.from_dict(obj["impressions"]) if obj.get("impressions") is not None else None,
