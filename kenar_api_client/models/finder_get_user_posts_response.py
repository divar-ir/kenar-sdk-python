...
class FinderGetUserPostsResponse(BaseModel):
    """
    FinderGetUserPostsResponse
    """ # noqa: E501
    posts: Optional[List[FinderGetUserPostsResponsePost]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "posts": [FinderGetUserPostsResponsePost.from_dict(_item) for _item in obj["posts"]] if obj.get("posts") is not None else None
        })
        return _obj
