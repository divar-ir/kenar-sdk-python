...
class ChatapiChatButtonRow(BaseModel):
    """
    ChatapiChatButtonRow
    """ # noqa: E501
    buttons: Optional[List[ChatapiChatButton]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "buttons": [ChatapiChatButton.from_dict(_item) for _item in obj["buttons"]] if obj.get("buttons") is not None else None
        })
        return _obj
