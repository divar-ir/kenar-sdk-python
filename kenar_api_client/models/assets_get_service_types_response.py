...
class AssetsGetServiceTypesResponse(BaseModel):
    """
    AssetsGetServiceTypesResponse
    """ # noqa: E501
    service_types: Optional[List[GetServiceTypesResponseServiceTypeData]] = None
    __properties: ClassVar[List[str]] = ["service_types"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "service_types": [GetServiceTypesResponseServiceTypeData.from_dict(_item) for _item in obj["service_types"]] if obj.get("service_types") is not None else None
        })
        return _obj
