...
class PaymentListTransactionsResponse(BaseModel):
    ...
    """ # noqa: E501
    next_page_token: Optional[StrictStr] = Field(default=None, description="توکن برای صفحه بعدی نتایج.")
    transactions: Optional[List[PaymentTransaction]] = Field(default=None, description="فهرست تراکنش‌هایی که با درخواست مطابقت دارند")
