...
class ChatapiGenerateUploadTokenResponse(BaseModel):
    """
    ChatapiGenerateUploadTokenResponse
    """ # noqa: E501
    token: Optional[StrictStr] = Field(default=None, description="A url safe base64 encoded token that can be used in the upload endpoint")
