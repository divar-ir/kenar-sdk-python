...
class AssetsGetCitiesResponse(BaseModel):
    """
    AssetsGetCitiesResponse
    """ # noqa: E501
    cities: Optional[List[AssetsEnumOption]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cities": [AssetsEnumOption.from_dict(_item) for _item in obj["cities"]] if obj.get("cities") is not None else None
        })
        return _obj
