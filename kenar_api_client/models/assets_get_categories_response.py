...
class AssetsGetCategoriesResponse(BaseModel):
    """
    AssetsGetCategoriesResponse
    """ # noqa: E501
    categories: Optional[List[AssetsEnumOption]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categories": [AssetsEnumOption.from_dict(_item) for _item in obj["categories"]] if obj.get("categories") is not None else None
        })
        return _obj
