...
class PaymentCommitWalletTransactionRequest(BaseModel):
    """
    PaymentCommitWalletTransactionRequest
    """ # noqa: E501
    token: Optional[StrictStr] = Field(default=None, description="Token of the transaction you want to commit")
