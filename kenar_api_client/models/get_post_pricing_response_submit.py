...
class GetPostPricingResponseSubmit(BaseModel):
    ...
    """ # noqa: E501
    available: Optional[StrictBool] = Field(default=None, description="نشان می‌دهد که آیا آگهی قابل ثبت است. اگر false باشد، API ثبت خطا برمی‌گرداند")
    cost_rials: Optional[StrictStr] = Field(default=None, description="هزینه ثبت آگهی به ریال")
