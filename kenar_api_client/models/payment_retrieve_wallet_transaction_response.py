...
class PaymentRetrieveWalletTransactionResponse(BaseModel):
    """
    PaymentRetrieveWalletTransactionResponse
    """ # noqa: E501
    transaction: Optional[PaymentWalletTransaction] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transaction": PaymentWalletTransaction.from_dict(obj["transaction"]) if obj.get("transaction") is not None else None
        })
        return _obj
