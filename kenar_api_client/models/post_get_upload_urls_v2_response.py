...
class PostGetUploadURLsV2Response(BaseModel):
    """
    PostGetUploadURLsV2Response
    """ # noqa: E501
    image: Optional[GetUploadURLsV2ResponseUploadFormat] = None
    video: Optional[GetUploadURLsV2ResponseUploadFormat] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "image": GetUploadURLsV2ResponseUploadFormat.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "video": GetUploadURLsV2ResponseUploadFormat.from_dict(obj["video"]) if obj.get("video") is not None else None
        })
        return _obj
