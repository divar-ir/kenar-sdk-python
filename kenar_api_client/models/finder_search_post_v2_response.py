...
class FinderSearchPostV2Response(BaseModel):
    """
    FinderSearchPostV2Response
    """ # noqa: E501
    posts: Optional[List[FinderSearchPostItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "posts": [FinderSearchPostItem.from_dict(_item) for _item in obj["posts"]] if obj.get("posts") is not None else None
        })
        return _obj
