...
class AddonsGetUserPostAddonsResponse(BaseModel):
    """
    AddonsGetUserPostAddonsResponse
    """ # noqa: E501
    addons: Optional[List[AddonsPostAddon]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "addons": [AddonsPostAddon.from_dict(_item) for _item in obj["addons"]] if obj.get("addons") is not None else None
        })
        return _obj
