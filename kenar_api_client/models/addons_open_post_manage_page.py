...
class AddonsOpenPostManagePage(BaseModel):
    """
    An action to open a post management page in the app
    """ # noqa: E501
    post_token: StrictStr = Field(description="Token of the post to redirect to its management page")
    __properties: ClassVar[List[str]] = ["post_token"]
